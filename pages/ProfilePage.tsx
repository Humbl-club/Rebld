        ...
        <main className="space-y-5">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <div className="w-14 h-14 rounded-2xl bg-[#E54D42]/10 flex items-center justify-center">
                <UserIcon className="w-7 h-7 text-[#E54D42]" />
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3">
              {/* Weight */}
              <div className="text-center p-4 rounded-2xl bg-[#E54D42]/10 border border-[#E54D42]/20">
                <p className="text-[10px] uppercase tracking-wider text-white/50 font-bold mb-1">
                  Weight
                </p>
                <p className="text-[24px] font-semibold text-[#E54D42] tabular-nums">
                  {bodyMetrics?.weight || '—'}
                </p>
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              <BookCheckIcon className="w-5 h-5 text-[#E54D42]" />
              <h3 className="text-[16px] font-bold text-white">
              ...
              <div className="p-5 border-b border-white/10">
                <div className="flex items-center justify-between">
                  <h3 className="text-[16px] font-bold text-white flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-[#E54D42]">
          ...
          {userId && (
            ...
            >
              <div className="p-5 border-b border-white/10">
                <h3 className="text-[16px] font-bold text-white flex items-center gap-2">
                  <TrophyIcon className="w-5 h-5 text-[#E54D42]" />
                  Achievements
                </h3>
              </div>
              <div className="p-5">
                      ...
                      {achievements.map((achievement) => (
                        <div
                          ...
                          className={cn(
                            ...
                            "bg-[#E54D42]/5 border border-white/10",
                            "active:scale-[0.98] transition-all duration-200"
                          )}
                        >
          ...
          {userProfile?.userCode && (
            ...
            >
              <div className="p-5 border-b border-white/10">
                <h3 className="text-[16px] font-bold text-white flex items-center gap-2">
                  <UsersIcon className="w-5 h-5 text-[#E54D42]" />
                  Your Buddy Code
                </h3>
              </div>
              <div className="p-5">
                <div className="p-6 rounded-2xl bg-[#E54D42]/10 border border-[#E54D42]/20 text-center">
                  <p className="text-[10px] uppercase tracking-widest text-white/50 font-bold mb-2">
                    Share This Code
                  </p>
                  <p className="text-[28px] font-semibold font-mono tracking-wider text-[#E54D42] mb-4">
                    {userProfile.userCode}
                  </p>
                  <button
                    onClick={() => {
